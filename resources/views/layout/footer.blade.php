<!-- FOOTER OPEN -->
<div class="demo-footer bg-black">
    <div class="container">
        <div class="row bg-black">
            <div class="card mb-0 bg-black">
                <div class="card-body">
                    ...
                    <footer class="main-footer px-0 pb-0 text-center bg-black">
                        <div class="row bg-black">
                            <div class="col-md-12 col-sm-12 text-white">
                                Copyright © <span id="year"></span> <a href="javascript:void(0)" class="text-white">Chat2</a> -
                                 All rights reserved.
                            </div>
                        </div>
                    </footer>
